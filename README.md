# Run Selenium Accessibility Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Java Selenium accessibility tests using the TestMu AI Accessibility Tool. This sample shows how to configure Selenium Java + TestMu AI Accessibility to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/lambdatest-accessibility-selenium && cd lambdatest-accessibility-selenium
mvn compile
```
